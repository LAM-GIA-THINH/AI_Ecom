                            ...
                            <div class="card">
                                ...
                                <div class="row">  
                                    ...
                                    <div class="mb-3 mt-3   col-md-6">
                                        ...
                                        <input type="text" name="slug" class="form-control" style="background-color:light-grey" placeholder="Đường dẫn" wire:model="slug" disabled/>
                                        @error('slug')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror                                        
                                    </div>
                                ...
                                <div class="row" >  
                                    <div class="mb-3 mt-3 col-md-3" >
                                        ...
                                        <select  class="form-control " style="background-color:white" name="category_id" wire:model.lazy="category_id" id="categorySelect" >
                                            ...
                                            @foreach($categories as $category)
                                                <option wire:ignore value="{{$category->id}}">{{$category->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('category_id')
                                            <p class="text-danger">{{$message}}</p>
                                    ...
                                    <div class="mb-3 mt-3" wire:ignore>
                                        ...
                                        <textarea wire:model.lazy="description" class="form-control" style="background-color:white; height: 150px;" name="description" placeholder="Nhập tóm tắt" id="description">{!! $content !!}</textarea>
                                        @error('description')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="file" name="image" class="form-control" style="background-color:white" wire:model.lazy="image"/>
                                        @if($image) 
