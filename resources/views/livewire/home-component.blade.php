                ...
                <div class="carousel-inner">
                    @foreach($slides as $index => $slide)
                        <div class="carousel-item {{ $index == 0 ? 'active' : '' }}" style="height: 410px;">
                            <img class="img-fluid" src="{{ asset('img/products/slider/' . $slide->image) }}" alt="Image">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-4 col-md-6 pb-1 {{ $index == 0 ? 'active' : '' }}">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    ...
                    <a href="{{ route('product.category', ['slug' => $category->slug]) }}" class="cat-img position-relative overflow-hidden mb-3">
